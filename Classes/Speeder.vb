...
#Region "Methods"
    ...
    Public Overloads Function DeleteFile() As Boolean
        ...
        If MyBase.Delete(Name, TitleName) Then
            Return True
        Else
            Return False
        End If
    ...
    Public Overloads Function CreateFile() As Boolean
        ...
        If MyBase.Create(Name, TitleName, GenerateData()) Then
            Return True
        Else
            Return False
        End If
    ...
    Public Overloads Function WriteFile() As Boolean
        ...
        If MyBase.Write(Name, TitleName, GenerateData()) Then
            Return True
        Else
            Dim tmpText As String
            Dim msgText As MessageText = New MessageText()
    ...
    Public Overloads Function ReadFile() As Boolean
        ...
        readValue = MyBase.Read(Name, Parameter.countFactor)
