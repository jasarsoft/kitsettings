...
#Region "Methods"
    ...
    Public Overloads Function Valid() As Boolean

        If MyBase.Valid(Info.fileName, Info.titleName) Then
            Return True
        Else
            Return False
        End If
    ...
    Public Overloads Function DeleteFile() As Boolean
        ...
        If MyBase.Delete(Name, Title) Then
            Return True
        Else
            Return False
        End If
    ...
    Public Overloads Function CreateFile() As Boolean
        ...
        If MyBase.Create(Name, Title, GenerateData()) Then
            Return True
        Else
            Return False
        End If
    ...
    Public Overloads Function WriteFile() As Boolean
        ...
        If MyBase.Write(Name, Title, GenerateData()) Then
            Return True
        Else
            Dim tmpText As String
            Dim msgText As MessageText = New MessageText()
    ...
    Public Overloads Function ReadFile() As Boolean
        ...
        readValue = MyBase.Read(Name, Parameter.reservedMemory)
        ...
        readValue = MyBase.Read(Name, Parameter.forceSW)
        If IsNumeric(readValue) Then
            _forceSW = MyBase.ConvertEnable(readValue)
        Else
            Return ReadError()
        End If
        readValue = MyBase.Read(Name, Parameter.emulateHW)
        If IsNumeric(readValue) Then
        ...
        readValue = MyBase.Read(Name, Parameter.fullscreenWidth)
        If IsNumeric(readValue) Then
        ...
        readValue = MyBase.Read(Name, Parameter.fullscreenHeight)
